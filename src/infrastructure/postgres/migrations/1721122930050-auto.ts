...
export class Auto1721122930050 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."accounts_role_enum" AS ENUM('owner', 'administrator', 'manager', 'employee', 'client')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."accounts_role_enum_old" AS ENUM('owner', 'administrator', 'manager', 'client')`);
        await queryRunner.query(`ALTER TABLE "accounts" ALTER COLUMN "role" DROP DEFAULT`);
